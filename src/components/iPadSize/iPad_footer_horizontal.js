...
class IpadFooterHorizontal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            hovered: false,
        ...
        return (
            <div style={{display: 'flex', justifyContent:'flex-end'}}>
                    <div style={{ marginRight:'3%', marginTop:'2%',
                     height:'5vh', width:'8%', display:'flex'}}>
                        <a href="https://www.facebook.com/" target="_blank">
                        <FontAwesomeIcon icon={['fab', 'facebook-f']} 
                                        style={{
                                            fontSize: this.state.hovered ? '3em': '1.5em',
                        ...
                        <FontAwesomeIcon icon={['fab', 'instagram']} 
                                        style={{
                                            fontSize: this.state.hovered2 ? '3em': '1.5em', 
                                            marginLeft:'15px',
                        ...
                        <FontAwesomeIcon icon={['fab', 'youtube']} 
                                        style={{
                                            fontSize: this.state.hovered3 ? '3em': '1.5em',
                                            marginLeft:'15px',
...
export default IpadFooterHorizontal;